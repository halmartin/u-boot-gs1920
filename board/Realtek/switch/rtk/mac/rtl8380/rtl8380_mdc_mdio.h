...
*
* $Revision: 9064 $
* $Date: 2010-04-15 19:47:09 +0800 (星期四, 15 四月 2010) $
*
...
#ifndef _RTL8380_MDCMDIO_H_
#define _RTL8380_MDCMDIO_H_

#include <rtk/drv/gpio/gpio.h>


typedef drv_gpio_direction_t gpio_direction_t;
...
extern int32 rtl8380_smiInit(uint32 pinMDC, uint32 pinMDIO);
void rtl8380_smiRead(uint32 phyad, uint32 regad, uint32 * data);
void rtl8380_smiWrite(uint32 phyad, uint32 regad, uint32 data);


#endif /*_RTL8380_MDCMDIO_H_*/
