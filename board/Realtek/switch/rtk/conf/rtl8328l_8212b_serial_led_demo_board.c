 ...
 * All rights reserved.
 *
 * Purpose : Related implementation of the RTL8328L_8212B serial led demo board for U-Boot.
 *
 * Feature : RTL8328L_8212B serial led demo board database
 *
 */
 ...
 * Data Declaration
 */
static const rtk_switch_model_t rtl8328l_8212b_serial_led_demo = {
    .name = "RTL8328L_8212B_SERIAL_LED_DEMO",
