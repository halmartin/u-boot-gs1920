 ...
 * Data Declaration
 */
static const rtk_switch_model_t rtl8382m_8218b_intphy_8218b_2fib_1g_demo = {
    .name = "RTL8382M_8218B_INTPHY_8218B_2FIB_1G_DEMO",
    ...
    .phy.list = {
        ...
        [3] =   { .chip = RTK_CHIP_NONE, .mac_id = 24,  .phy_max = 4 },
    }   /* .phy.list */
};
