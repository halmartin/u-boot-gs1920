 ...
 * Data Declaration
 */
static const rtk_switch_model_t rtl8332m_8208l_intphy_8208l_8214b_demo = {
    .name = "RTL8332M_8208L_INTPHY_8208L_8214B_DEMO",
    ...
    .phy.list = {
        ...
        [3] =   { .chip = RTK_CHIP_RTL8214FB, .mac_id = 24,  .phy_max = 4 },
    }   /* .phy.list */
};
