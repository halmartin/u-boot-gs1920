 ...
 * Data Declaration
 */
static const rtk_switch_model_t rtl8353m_demo = {
    .name = "RTL8353M_DEMO",
    ...
    .led.led_definition_set[1].led[1] = 0xF,    /* 10/100Mbps link/act */
    .led.led_definition_set[1].led[2] = 0x6,    /* duplex mode */
    /* LED definition selection (per-port) */
    .led.led_copr_set_psel_bit0_pmask[0] = 0xFFFFFFFF,
    .led.led_copr_set_psel_bit1_pmask[0] = 0x00000000,
    .led.led_copr_set_psel_bit0_pmask[1] = 0x0000FFFF,
    ...
    .phy.list = {
        ...
        [6] = { .chip = RTK_CHIP_RTL8214FC, .mac_id = 48, .phy_max = 4},
    }   /* .phy.list */
};
