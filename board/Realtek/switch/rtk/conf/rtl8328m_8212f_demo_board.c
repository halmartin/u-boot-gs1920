 ...
 * All rights reserved.
 *
 * Purpose : Related implementation of the RTL8328M_8212F demo board for U-Boot.
 *
 * Feature : RTL8328M_8212F demo board database
 *
 */
 ...
 * Data Declaration
 */
static const rtk_switch_model_t rtl8328m_8212f_demo = {
    .name = "RTL8328M_8212F_DEMO",
    ...
    .phy.list = {
        ...
        [3] =   { .chip = RTK_CHIP_RTL8212F, .phyid = 24, .phy_max = 2 },
    }   /* .phy.list */
};
