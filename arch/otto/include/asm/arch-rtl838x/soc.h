...
#define SPI_NOR_FLASH_MMIO_SIZE0 (0x04000000) /* 64MB */
...
#define OTTO_FLASH_ADDR_MODE() \
	({ \
		...
		*((volatile u32_t *)(0xBB000058)) = 0x3; \
		switch(*((volatile u32_t *)(0xBB0000D0))){ \
			case 0x0:\
				if (*((volatile u32_t *)(0xBB00100C)) & (1<<29)) { \
			__res = 4; \
		} \
				break; \
			case 0x2:\
			default:\
				spif4BRegVal = *((volatile u32_t *)(0xBB000FF8)); \
	...
	({ \
		*((volatile u32_t *)(0xBB000058)) = 0x3;\
		switch(*((volatile u32_t *)(0xBB0000D0))){ \
			...
			case 0x2:\
			default:\
		tmp = *((volatile u32_t *)(0xBB000FF8));\
		tmp &= ~(0xC0000000);\
		tmp |= (0xCFFFFFFF);\
		*((volatile u32_t *)(0xBB000FF8)) = tmp;\
		break; \
		}\
		*((volatile u32_t *)(0xBB000058)) = 0x0;\
	})
...
#define OTTO_FLASH_DISABLE_4BYTE_ADDR_MODE() \
    ({ \
		*((volatile u32_t *)(0xBB000058)) = 0x3; \
		switch(*((volatile u32_t *)(0xBB0000D0))){ \
			case 0x0:\
...
//#define LPLR_WAIT_ICE_DELAY_LOOP 250000
...
#define SOC_HEADER_VERSION      0x00000924  // which means 0.0.9.36
