...
extern int rtl8390_initialize(bd_t*);
#endif
#if defined(CONFIG_RTL8380)
extern int rtl8380_initialize(bd_t*);
#endif
...
#endif
#if defined(CONFIG_RTL8390)
	rtl8390_initialize(bis);
#endif
#if defined(CONFIG_RTL8380)
	rtl8380_initialize(bis);
#endif
...
int eth_recv(unsigned char **pkt, int max_len)
{
	if (!eth_current)
		return -1;

	return swnic_rx_pkt(eth_current, pkt, max_len);
}
